...
class Teams(commands.Cog):
    ...
    async def createteam(self, interaction: discord.Interaction, name: str):
        ...
        try:
            ...
            print(f"[ERROR] /createteam error: {e}")
            traceback.print_exc()
            await interaction.response.send_message("❌ An error occurred while creating the team. Please try again.", ephemeral=True)
    ...
    async def inviteteam(self, interaction: discord.Interaction, user: discord.Member):
        print(f"[DEBUG] /inviteteam called by {interaction.user} for user: {user.display_name}")
        try:
            ...
            print(f"[ERROR] /inviteteam error: {e}")
            traceback.print_exc()
            await interaction.response.send_message("❌ An error occurred while inviting the user. Please try again.", ephemeral=True)
    ...
    async def jointeam(self, interaction: discord.Interaction, name: str):
        ...
        try:
            ...
            print(f"[ERROR] /jointeam error: {e}")
            traceback.print_exc()
            await interaction.response.send_message("❌ An error occurred while joining the team. Please try again.", ephemeral=True)
    ...
    async def promote(self, interaction: discord.Interaction, user: discord.Member, role: str):
        ...
        try:
            ...
            print(f"[ERROR] /promote error: {e}")
            traceback.print_exc()
            await interaction.response.send_message("❌ An error occurred while promoting the user. Please try again.", ephemeral=True)
    ...
    async def demote(self, interaction: discord.Interaction, user: discord.Member):
        ...
        try:
            ...
            print(f"[ERROR] /demote error: {e}")
            traceback.print_exc()
            await interaction.response.send_message("❌ An error occurred while demoting the user. Please try again.", ephemeral=True)
    ...
    async def team(self, interaction: discord.Interaction):
        ...
        try:
            ...
            print(f"[ERROR] /team error: {e}")
            traceback.print_exc()
            await interaction.response.send_message("❌ An error occurred while loading the team info. Please try again.", ephemeral=True)
